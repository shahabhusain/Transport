...
const Company = () => {
  return (
    <div className=' flex flex-col md:flex-row items-center mt-32 justify-around w-[80%] mx-auto'>
        <img className=' md:w-[50%]' src={com} alt="" />
        <div className=' flex flex-col md:w-[40%] gap-4 w-full'>
            ...
            <div className=' flex gap-4 items-center'>
                <button className=' bg-[#F4F4F4] py-3 px-6 md:text-[15px] text-[10px]'>Our Approch</button>
                <button className=' bg-[#F4F4F4] py-3 px-6 md:text-[15px] text-[10px]'>Our Approch</button>
                <button className=' bg-[#F4F4F4] py-3 px-6 md:text-[15px] text-[10px]'>Our Approch</button>
            </div>
