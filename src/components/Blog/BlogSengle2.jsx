    ...
    <>
      <div className=" bc3 h-[522px]">
        <div className=" md:pt-60 pt-56 md:pl-32 pl-4 ">
          ...
          <h1 className=" font-bold md:text-[44px] text-[33px] text-white max-w-[644px]">
            How technology can help redraw the supply chain map
          </h1>
        </div>
      </div>

      <div className=" md:mx-60 mx-4 mt-32">
        <div>
          <h1 className=" md:text-[44px] text-[33px] font-bold">Your Logistics Solutions</h1>
          <p className=" mt-4">
